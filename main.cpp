...
private:
    ...
    void personPlayer(){
        ...
        while (flag1==0){
           ...
           list<int>::iterator li;
           int counter=1;
           for (li=L.begin(); li!=L.end(); li++){if (counter==brojhrpe){break;}; counter++;};
           nahrpi=(*li);

           if (brojhrpe<=velicina && brojhrpe>0 && nahrpi>2){flag1=1;}else{cout<< "Pogresan unos! Probajte opet. ";};
             };
...
int main()
{
    cout << "Upisite pocetni broj novcica na hrpi (izmedju 1 i 100): ";
    int n;
    cin >> n;
